 ...
 * French Audio Worker
 * --------------------
 * Consumes the "french-audio" queue: synthesizes CosyVoice 2 speech (cloning
 * the original broadcast's voice) for the persisted French translation and
 * saves it to MinIO as `<filename>.fr.wav`.
 *
